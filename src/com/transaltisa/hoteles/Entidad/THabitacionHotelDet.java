...
public class THabitacionHotelDet implements Serializable{
...
/*    public THabitacionHotel(Long habHotId, TPisosHotel pisosHotel, Long pisosHotelId, String detNumHab, String tipoHab, String estadoHab) {
    ...
    public THabitacionHotelDet(MHotel hotel, Long habHotId, Long hotelId, Long pisosHotelId, TPisosHotel pisosHotel, String detNumHab, String tipoHab, String estadoHab, Long personalRelevoId, String fechaIniOcupa, String fechaFinOcupa, String estadoOcupa) {
        this.hotel = hotel;
        this.habHotId = habHotId;
    ...
    public MHotel getHotel() {
        return hotel;
    }

    public void setHotel(MHotel hotel) {
        this.hotel = hotel;
    }
